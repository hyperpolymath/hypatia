...
defmodule Hypatia.Data.Models do
  ...
  defmodule Finding do
    ...
    defstruct [
      ...
      :confidence,
      :scan_timestamp,
      # :open, :dispatched, :fixed, :false_positive, :wont_fix
      :status,
      :fix_recipe_id,
      :dispatched_to_bot,
      :verisim_id
  ...
  defmodule Recipe do
    ...
    defstruct [
      ...
      :strategy,
      # :replace, :inject, :delete, :command, :pr
      :language,
      :fix_type,
      :confidence,
      :confidence_floor,
  ...
  defmodule ConfidenceHistory do
    ...
    defstruct [
      ...
      :recipe_id,
      :timestamp,
      # :outcome, :decay, :manual, :learning_cycle
      :confidence,
      :event_type,
  ...
  defmodule DispatchBatch do
    ...
    defstruct [
      ...
      :dispatch_count,
      :strategy,
      # :pending, :executing, :completed, :rolled_back
      :status,
      :rollback_reason,
      :rollback_timestamp
    ]
