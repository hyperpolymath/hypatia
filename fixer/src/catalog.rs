...
impl ErrorCatalog {
    pub fn new() -> Self {
        ...
        // Workflow Security
        patterns.insert(
            "token-permissions-id".to_string(),
            ErrorPattern {
        ...
        patterns.insert(
            "pinned-dependencies-id".to_string(),
            ErrorPattern {
        ...
        patterns.insert(
            "workflow-linter-self-detection".to_string(),
            ErrorPattern {
                id: "workflow-linter-self-detection".to_string(),
                error_type: ErrorType::WorkflowSecurity,
                severity: Severity::Low,
                auto_fixable: true,
                description: "Workflow linter grep matches its own comments containing 'uses:'"
                    .to_string(),
                fix_pattern: "Add grep -v filters for comment lines and specific patterns"
                    .to_string(),
            },
        );

        patterns.insert(
            "missing-action-input".to_string(),
            ErrorPattern {
                ...
                fix_pattern: "Add 'with:' section with required inputs (e.g., toolchain: stable)"
                    .to_string(),
            },
        );
        ...
        patterns.insert(
            "missing-workflow-permissions".to_string(),
            ErrorPattern {
        ...
        // Code Security
        patterns.insert(
            "hard-coded-cryptographic-value".to_string(),
            ErrorPattern {
        ...
        patterns.insert(
            "remote-property-injection".to_string(),
            ErrorPattern {
        ...
        patterns.insert(
            "branch-protection-id".to_string(),
            ErrorPattern {
    ...
    pub fn auto_fixable(&self) -> Vec<&ErrorPattern> {
        self.patterns.values().filter(|p| p.auto_fixable).collect()
    }
