...
. *Environment:* Use `+guix shell -D -f build/guix.scm+` (or `+direnv allow+`)
to set up your tools. Guix is the canonical packager per
https://github.com/hyperpolymath/standards/issues/101[standards#101];
the prior `+nix develop+` fallback was retired.
