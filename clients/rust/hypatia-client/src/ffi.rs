...
// hypatia: allow code_safety/from_raw
// hypatia: allow code_safety/unsafe_block
// hypatia: allow code_safety/as_ptr
//
// # Safety
//
...
use crate::types::{
    DispatchEntry, DispatchStrategy, Finding, HealthReport, OutcomeRecord, ScanRequest,
...
impl FfiTransport {
    ...
    fn bind_symbols(lib: Library) -> Result<Self, HypatiaError> {
        ...
        unsafe {
            ...
            let get_confidence: Symbol<unsafe extern "C" fn(*const u8, usize, *mut f64) -> c_int> =
