...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_hypatia_main" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#a1741d3d#;
   pragma Export (C, u00001, "hypatia_mainB");
   ...
   u00137 : constant Version_32 := 16#dcb9b3d9#;
   pragma Export (C, u00137, "system__os_locksS");
   u00138 : constant Version_32 := 16#cf43d8a1#;
   ...
   u00140 : constant Version_32 := 16#fe72077f#;
   pragma Export (C, u00140, "hypatiaS");
   u00141 : constant Version_32 := 16#b6d14062#;
   pragma Export (C, u00141, "hypatia__applicationB");
   u00142 : constant Version_32 := 16#20ae72f1#;
   pragma Export (C, u00142, "hypatia__applicationS");
   u00143 : constant Version_32 := 16#3cf430e6#;
   pragma Export (C, u00143, "hypatia__state_machineB");
   u00144 : constant Version_32 := 16#83cdc6d8#;
   pragma Export (C, u00144, "hypatia__state_machineS");
   u00145 : constant Version_32 := 16#e74c414e#;
   pragma Export (C, u00145, "hypatia__terminalB");
   u00146 : constant Version_32 := 16#05d33dff#;
   pragma Export (C, u00146, "hypatia__terminalS");
   u00147 : constant Version_32 := 16#44c0827e#;
   pragma Export (C, u00147, "hypatia__posixB");
   u00148 : constant Version_32 := 16#a2ecd69a#;
   pragma Export (C, u00148, "hypatia__posixS");
   u00149 : constant Version_32 := 16#afdc38b2#;
   pragma Export (C, u00149, "system__arith_64B");
   u00150 : constant Version_32 := 16#509fabdd#;
   pragma Export (C, u00150, "system__arith_64S");
   u00151 : constant Version_32 := 16#e259c480#;
   pragma Export (C, u00151, "system__assertionsB");
   u00152 : constant Version_32 := 16#322b1494#;
   pragma Export (C, u00152, "system__assertionsS");
   u00153 : constant Version_32 := 16#8b2c6428#;
   pragma Export (C, u00153, "ada__assertionsB");
   u00154 : constant Version_32 := 16#cc3ec2fd#;
   pragma Export (C, u00154, "ada__assertionsS");
   u00155 : constant Version_32 := 16#27f33f31#;
   pragma Export (C, u00155, "ada__strings__boundedB");
   u00156 : constant Version_32 := 16#7c1fc0ad#;
   pragma Export (C, u00156, "ada__strings__boundedS");
   u00157 : constant Version_32 := 16#b40d9bf2#;
   ...
   u00159 : constant Version_32 := 16#b037be72#;
   pragma Export (C, u00159, "ada__strings__superboundedB");
   u00160 : constant Version_32 := 16#e0340eac#;
   pragma Export (C, u00160, "ada__strings__superboundedS");
   u00161 : constant Version_32 := 16#9e22e78c#;
   pragma Export (C, u00161, "hypatia__viewsB");
   u00162 : constant Version_32 := 16#0954e054#;
   pragma Export (C, u00162, "hypatia__viewsS");
   ...
   u00170 : constant Version_32 := 16#1e613ff4#;
   pragma Export (C, u00170, "hypatia__views__fleetB");
   u00171 : constant Version_32 := 16#b98e8717#;
   pragma Export (C, u00171, "hypatia__views__fleetS");
   u00172 : constant Version_32 := 16#8f2b55da#;
   pragma Export (C, u00172, "hypatia__widgetsB");
   u00173 : constant Version_32 := 16#f993ea3a#;
   pragma Export (C, u00173, "hypatia__widgetsS");
   u00174 : constant Version_32 := 16#ca878138#;
   pragma Export (C, u00174, "system__concat_2B");
   u00175 : constant Version_32 := 16#a1d318f8#;
   ...
   u00178 : constant Version_32 := 16#4259a79c#;
   pragma Export (C, u00178, "ada__strings__unboundedB");
   u00179 : constant Version_32 := 16#b40332b4#;
   pragma Export (C, u00179, "ada__strings__unboundedS");
   u00180 : constant Version_32 := 16#d79db92c#;
   ...
   u00183 : constant Version_32 := 16#34ba7966#;
   pragma Export (C, u00183, "hypatia__widgets__listB");
   u00184 : constant Version_32 := 16#920491a9#;
   pragma Export (C, u00184, "hypatia__widgets__listS");
   u00185 : constant Version_32 := 16#c3b32edd#;
   pragma Export (C, u00185, "ada__containers__helpersB");
   u00186 : constant Version_32 := 16#444c93c2#;
   pragma Export (C, u00186, "ada__containers__helpersS");
   u00187 : constant Version_32 := 16#ae5b86de#;
   pragma Export (C, u00187, "system__pool_globalB");
   u00188 : constant Version_32 := 16#a07c1f1e#;
   pragma Export (C, u00188, "system__pool_globalS");
   u00189 : constant Version_32 := 16#0ddbd91f#;
   pragma Export (C, u00189, "system__memoryB");
   u00190 : constant Version_32 := 16#0cbcf715#;
   ...
   u00192 : constant Version_32 := 16#8e431254#;
   ...
   u00197 : constant Version_32 := 16#b3f7543e#;
   pragma Export (C, u00197, "system__strings__stream_opsB");
   u00198 : constant Version_32 := 16#46dadf54#;
   pragma Export (C, u00198, "system__strings__stream_opsS");
   u00199 : constant Version_32 := 16#a9ad2406#;
   pragma Export (C, u00199, "hypatia__widgets__status_barB");
   u00200 : constant Version_32 := 16#bb409cec#;
   pragma Export (C, u00200, "hypatia__widgets__status_barS");
   u00201 : constant Version_32 := 16#792b890f#;
   pragma Export (C, u00201, "hypatia__views__helpB");
   u00202 : constant Version_32 := 16#b2c65e02#;
   pragma Export (C, u00202, "hypatia__views__helpS");
   u00203 : constant Version_32 := 16#ffadf74c#;
   pragma Export (C, u00203, "hypatia__views__main_menuB");
   u00204 : constant Version_32 := 16#355ff5df#;
   pragma Export (C, u00204, "hypatia__views__main_menuS");
   u00205 : constant Version_32 := 16#dcf1b173#;
   pragma Export (C, u00205, "hypatia__views__registryB");
   u00206 : constant Version_32 := 16#937e33d6#;
   pragma Export (C, u00206, "hypatia__views__registryS");
   u00207 : constant Version_32 := 16#d477b12d#;
   pragma Export (C, u00207, "hypatia__views__scanB");
   u00208 : constant Version_32 := 16#e270ed7f#;
   pragma Export (C, u00208, "hypatia__views__scanS");
   u00209 : constant Version_32 := 16#d843d1ef#;
   pragma Export (C, u00209, "hypatia__views__settingsB");
   u00210 : constant Version_32 := 16#ce8c7c2f#;
   pragma Export (C, u00210, "hypatia__views__settingsS");
   ...
   --  hypatia.posix%s
   --  hypatia.posix%b
   --  hypatia.state_machine%s
   --  hypatia.state_machine%b
   --  hypatia.terminal%s
   --  hypatia.terminal%b
   --  hypatia.views%s
   --  hypatia.views%b
   --  hypatia.widgets%s
   --  hypatia.widgets%b
   --  hypatia.widgets.list%s
   --  hypatia.widgets.list%b
   --  hypatia.widgets.status_bar%s
   --  hypatia.widgets.status_bar%b
   --  hypatia.views.fleet%s
   --  hypatia.views.fleet%b
   --  hypatia.views.help%s
   --  hypatia.views.help%b
   --  hypatia.views.main_menu%s
   --  hypatia.views.main_menu%b
   --  hypatia.views.registry%s
   --  hypatia.views.registry%b
   --  hypatia.views.scan%s
   --  hypatia.views.scan%b
   --  hypatia.views.settings%s
   --  hypatia.views.settings%b
   --  hypatia.application%s
   --  hypatia.application%b
   --  hypatia_main%b
