...
fn get_available_bots() -> Vec<Bot> {
    vec![
        ...
        Bot {
            id: "accessibilitybot".to_string(),
            name: "Accessibilitybot".to_string(),
            description: "Tier 2 Finisher - WCAG 2.3 AAA accessibility compliance".to_string(),
            category: BotCategory::Quality,
            dependencies: vec!["robot-repo-automaton".to_string(), "glambot".to_string()],
            checks: vec![
