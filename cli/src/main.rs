...
fn print_exit_codes(format: OutputFormat) -> Result<()> {
    ...
    let codes = vec![
        ...
        ExitCodeInfo {
            code: 4,
            name: "IO_ERROR",
            description: "IO error (file read/write, network)",
            category: "General Errors",
        },
        ExitCodeInfo {
            code: 5,
        ...
        ExitCodeInfo {
            code: 11,
            name: "HIGH_FINDINGS",
            description: "High severity findings detected",
            category: "Scan Results",
        },
        ExitCodeInfo {
            code: 12,
            name: "MEDIUM_FINDINGS",
            description: "Medium severity findings detected",
            category: "Scan Results",
        },
        ExitCodeInfo {
            code: 13,
            name: "LOW_FINDINGS",
            description: "Low severity findings detected",
            category: "Scan Results",
        },
        ExitCodeInfo {
            code: 14,
            name: "INFO_FINDINGS",
            description: "Info level findings only",
            category: "Scan Results",
        },
        ExitCodeInfo {
            code: 15,
        ...
        ExitCodeInfo {
            code: 20,
            name: "REGISTRY_CONNECTION_ERROR",
            description: "Registry connection failed",
            category: "Registry Errors",
        },
        ExitCodeInfo {
            code: 21,
            name: "REGISTRY_AUTH_ERROR",
            description: "Registry authentication failed",
            category: "Registry Errors",
        },
        ExitCodeInfo {
            code: 22,
        ...
        ExitCodeInfo {
            code: 23,
            name: "RULESET_CONFLICT",
            description: "Ruleset version conflict",
            category: "Registry Errors",
        },
        ExitCodeInfo {
            code: 24,
            name: "RULESET_INVALID",
            description: "Ruleset validation failed",
            category: "Registry Errors",
        },
        ExitCodeInfo {
            code: 25,
            name: "REGISTRY_RATE_LIMIT",
        ...
        ExitCodeInfo {
            code: 35,
            name: "HOOK_ERROR",
            description: "Hook installation/execution failed",
            category: "Repository Errors",
        },
        ExitCodeInfo {
            code: 40,
            name: "BOT_FAILED",
            description: "Bot execution failed",
            category: "Fleet Errors",
        },
        ExitCodeInfo {
            code: 41,
            name: "BOT_NOT_FOUND",
        ...
        ExitCodeInfo {
            code: 42,
            name: "FLEET_PARTIAL_FAILURE",
            description: "Fleet operation partially failed",
            category: "Fleet Errors",
        },
        ExitCodeInfo {
            code: 43,
            name: "FLEET_TOTAL_FAILURE",
            description: "Fleet operation completely failed",
            category: "Fleet Errors",
        },
        ExitCodeInfo {
            code: 44,
            name: "BOT_DEPENDENCY_ERROR",
            description: "Bot dependency error",
            category: "Fleet Errors",
        },
        ExitCodeInfo {
            code: 50,
            name: "PARTIAL_FAILURE",
            description: "Batch operation partially succeeded",
            category: "Batch Results",
        },
        ExitCodeInfo {
            code: 51,
            name: "TOTAL_FAILURE",
            description: "Batch operation completely failed",
            category: "Batch Results",
        },
        ExitCodeInfo {
            code: 52,
        ...
        ExitCodeInfo {
            code: 100,
            name: "INTERNAL_ERROR",
            description: "Internal error (panic, unexpected state)",
