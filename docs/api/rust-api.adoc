...
The hypatia platform is implemented as a Rust workspace with multiple crates. This document provides an overview of the public APIs exposed by each crate.
