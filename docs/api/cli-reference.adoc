...
The `hyper` CLI is the command-line interface for the hypatia neurosymbolic CI/CD platform. It combines neural learning with symbolic reasoning to provide intelligent CI/CD automation and issue detection.

=== Installation

[source,bash]
----
cargo install hypatia-cli
----
