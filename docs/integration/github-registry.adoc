...
= GitHub Registry Integration for hypatia
:toc: left
:toclevels: 3
:icons: font
:sectnums:
...
This document evaluates GitHub's built-in registry systems as alternatives to a self-hosted registry for storing and distributing hypatia rulesets. The analysis covers four options: GitHub Packages, GitHub Container Registry (ghcr.io), GitHub Releases, and GitHub Actions Artifacts.
...
GitHub Packages provides package hosting for multiple ecosystems. For hypatia rulesets, we could package them as:
...
----
{
  ...
  "keywords": ["hypatia", "ruleset", "security"],
...
[registries.github]
index = "sparse+https://github.com/hyperpolymath/hypatia-registry/index/"
...
[source]
----
ghcr.io/hyperpolymath/hypatia-rulesets/security/workflow-pins:1.0.0
                  │                         │        │              │
...
----
{
  ...
  "config": {
    "mediaType": "application/vnd.hypatia.ruleset.config.v1+json",
    "size": 233,
    "digest": "sha256:abc..."
  },
  "layers": [
    {
      "mediaType": "application/vnd.hypatia.ruleset.content.v1+yaml",
      "size": 4521,
      "digest": "sha256:def...",
      "annotations": {
        "org.opencontainers.image.title": "workflow-pins.yaml",
        "dev.hypatia.category": "security",
        "dev.hypatia.version": "1.0.0"
      }
    }
  ],
  "annotations": {
    "org.opencontainers.image.source": "https://github.com/hyperpolymath/hypatia",
...
oras push ghcr.io/hyperpolymath/hypatia-rulesets/security/workflow-pins:1.0.0 \
  --artifact-type application/vnd.hypatia.ruleset.v1 \
  --annotation "org.opencontainers.image.source=https://github.com/hyperpolymath/hypatia" \
  --annotation "dev.hypatia.category=security" \
  workflow-pins.yaml:application/vnd.hypatia.ruleset.content.v1+yaml

# Tag as latest
oras tag ghcr.io/hyperpolymath/hypatia-rulesets/security/workflow-pins:1.0.0 latest
----
...
----
# Pull ruleset
oras pull ghcr.io/hyperpolymath/hypatia-rulesets/security/workflow-pins:1.0.0 \
  --output ./rulesets/

# Pull by digest (immutable)
oras pull ghcr.io/hyperpolymath/hypatia-rulesets/security/workflow-pins@sha256:abc123...

# List tags
oras repo tags ghcr.io/hyperpolymath/hypatia-rulesets/security/workflow-pins
----
...
curl -H "Authorization: Bearer ${GITHUB_TOKEN}" \
  "https://api.github.com/orgs/hyperpolymath/packages/container/hypatia-rulesets%2Fsecurity%2Fworkflow-pins/versions"

# Delete a version (admin only)
curl -X DELETE -H "Authorization: Bearer ${GITHUB_TOKEN}" \
  "https://api.github.com/orgs/hyperpolymath/packages/container/hypatia-rulesets%2Fsecurity%2Fworkflow-pins/versions/12345"
----
...
impl GhcrRegistry {
    pub fn new(token: &str) -> Result<Self> {
        ...
        Ok(Self {
            client,
            namespace: "ghcr.io/hyperpolymath/hypatia-rulesets".to_string(),
        })
    }
    ...
    pub async fn deposit(&self, ruleset: &Ruleset, content: &[u8]) -> Result<String> {
        ...
        let config = OciConfig {
            media_type: "application/vnd.hypatia.ruleset.config.v1+json",
            config: serde_json::to_vec(&ruleset.metadata)?,
        };

        let layer = OciLayer {
            media_type: "application/vnd.hypatia.ruleset.content.v1+yaml",
            data: content.to_vec(),
            annotations: HashMap::from([
                ("dev.hypatia.category".into(), ruleset.metadata.category.to_string()),
            ]),
        };
        ...
        let manifest = OciManifest::build()
            ...
            .annotations(HashMap::from([
                ("org.opencontainers.image.source".into(),
                 "https://github.com/hyperpolymath/hypatia".into()),
            ]))
            .build()?;
...
[source]
----
https://github.com/hyperpolymath/hypatia-rulesets/releases/tag/v1.0.0
...
curl -H "Authorization: Bearer ${GITHUB_TOKEN}" \
  ...
  "https://api.github.com/repos/hyperpolymath/hypatia-rulesets/releases/assets/12345"

# Public repos: Direct download, no auth needed
curl -LO "https://github.com/hyperpolymath/hypatia-rulesets/releases/download/v1.0.0/workflow-pins.yaml"
----
...
gh release create v1.0.0 \
  --repo hyperpolymath/hypatia-rulesets \
...
curl -X POST \
  ...
  "https://api.github.com/repos/hyperpolymath/hypatia-rulesets/releases" \
  -d '{
    "tag_name": "v1.0.0",
...
curl -X POST \
  ...
  "https://uploads.github.com/repos/hyperpolymath/hypatia-rulesets/releases/12345/assets?name=workflow-pins.yaml"
----
...
# List releases
gh release list --repo hyperpolymath/hypatia-rulesets
----
...
# List artifacts
curl -H "Authorization: Bearer ${GITHUB_TOKEN}" \
  "https://api.github.com/repos/hyperpolymath/hypatia/actions/artifacts"

# Download artifact (returns zip)
curl -H "Authorization: Bearer ${GITHUB_TOKEN}" \
  -H "Accept: application/vnd.github+json" \
  -L -o artifact.zip \
  "https://api.github.com/repos/hyperpolymath/hypatia/actions/artifacts/12345/zip"
----
...
----
┌─────────────────────────────────────────────────────────────────────┐
│                hypatia Registry Architecture                    │
├─────────────────────────────────────────────────────────────────────┤
│                                                                      │
│  ┌─────────────────────────────────────────────────────────────┐    │
│  │                 PRIMARY: ghcr.io (OCI)                       │    │
│  │                                                               │    │
│  │  ghcr.io/hyperpolymath/hypatia-rulesets/                │    │
...
│  │  - hypatia-rulesets-v1.0.0-all.tar.gz                   │    │
│  │  - hypatia-rulesets-v1.0.0-security.tar.gz              │    │
    ...
    match backend {
        ...
        RegistryBackend::SelfHosted => {
            let url = config.registry_url.clone()
                .unwrap_or_else(|| "https://registry.hypatia.dev".into());
...
const NAMESPACE: &str = "hyperpolymath/hypatia-rulesets";

/// Custom media types for hypatia rulesets
mod media_types {
    pub const CONFIG: &str = "application/vnd.hypatia.ruleset.config.v1+json";
    pub const CONTENT_YAML: &str = "application/vnd.hypatia.ruleset.content.v1+yaml";
    pub const CONTENT_JSON: &str = "application/vnd.hypatia.ruleset.content.v1+json";
}
    ...
    fn build_manifest(
        ...
        OciManifest {
            ...
            annotations: Some(HashMap::from([
                ...
                ("dev.hypatia.category".into(),
                 metadata.category.to_string()),
                ("dev.hypatia.version".into(),
      ...
      - name: Push rulesets to ghcr.io
        run: |
          for file in registry/rulesets/*.yaml; do
            ...
            oras push "ghcr.io/hyperpolymath/hypatia-rulesets/${category}/${name}:${version}" \
              --artifact-type application/vnd.hypatia.ruleset.v1 \
              "$file:application/vnd.hypatia.ruleset.content.v1+yaml"

            oras tag "ghcr.io/hyperpolymath/hypatia-rulesets/${category}/${name}:${version}" latest
          done
...
[source,toml]
----
# ~/.config/hypatia/config.toml

# Use GitHub Container Registry
registry_backend = "ghcr"

# Optional: Override namespace
# registry_namespace = "hyperpolymath/hypatia-rulesets"
----
...
OLD_REGISTRY="https://registry.hypatia.dev"
NEW_NAMESPACE="ghcr.io/hyperpolymath/hypatia-rulesets"
...
cosign sign ghcr.io/hyperpolymath/hypatia-rulesets/security/workflow-pins:1.0.0

# Verify during withdraw
cosign verify ghcr.io/hyperpolymath/hypatia-rulesets/security/workflow-pins:1.0.0 \
  --certificate-identity https://github.com/hyperpolymath/hypatia/.github/workflows/release-rulesets.yml@refs/tags/rulesets-v1.0.0 \
...
- uses: slsa-framework/slsa-github-generator/.github/workflows/generator_container_slsa3.yml@v2.1.0
  with:
    image: ghcr.io/hyperpolymath/hypatia-rulesets
