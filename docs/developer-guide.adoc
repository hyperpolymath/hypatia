...
This guide covers development of hypatia components, including writing rules in Logtalk, creating rulesets in Haskell, developing forge adapters, and contributing to the project.
...
hypatia uses GADTs for type-safe rule definitions:
