...
* link:https://www.gnu.org/licenses/agpl-3.0[PLMP-1.0-or-later] (legal)
* link:https://github.com/hyperpolymath/palimpsest-license[Palimpsest Licence] (philosophical)
